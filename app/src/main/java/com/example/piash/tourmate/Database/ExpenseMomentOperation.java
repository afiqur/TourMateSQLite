package com.example.piash.tourmate.Database;
...
public class ExpenseMomentOperation {
    ...
    public ExpenseMomentOperation(Context context) {
    ...
    public boolean addExpenseMoment(ExpenseMoment expenseMoment) {
        ...
        //values.put(DatabaseHelper.COL_EXPENSE_MOMENT_EVENT_ID_USER_ID_FOREIGN, expenseMoment.getEventIdForeign());
    ...
    public ArrayList<ExpenseMoment> getAllExpenseMoments(int eventId) {
...
//        int eventIdUserIdForeign = cursor.getInt(cursor.getColumnIndex(DatabaseHelper
//                .COL_EXPENSE_MOMENT_EVENT_ID_USER_ID_FOREIGN));
